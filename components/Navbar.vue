...
<template>
    <div>
        ...
        <div class="w-full p-6 mx-auto bg-slate-950 block md:hidden">
            <button class="block absolute top-1 w-5 h-12" @click="hamburgerOpen = true">
                <span class="h-0.5 w-6 bg-gray-200 block absolute"></span>
                <span class="h-0.5 w-6 bg-gray-200 block absolute top-2"></span>
                <span class="h-0.5 w-6 bg-gray-200 block absolute top-4"></span>
            </button>
        </div>
